 ...
 */
public class TwoDrawnCardStateTest {
    @Test
    public void testDrawTrainCardFromDeck(){
        boolean passed = true;
        boolean test;

        GameState state = new TwoDrawnCardState(new ClientGame(9, "andrew", 5, new ClientBank(), new GameMap(new HashMap<String, City>(), new HashMap<Integer, Route>())));
        try {
