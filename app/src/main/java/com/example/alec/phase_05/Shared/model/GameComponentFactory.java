...
public final class GameComponentFactory {
    ...
    public static Map<Integer, Route> createRoute(Map<String, City> cities) {
        ...
        routes.put(13, new Route(cities.get("San Francisco"), cities.get("Salt Lake City"), 5, null, FREIGHT, 13, 14));
        routes.put(14, new Route(cities.get("San Francisco"), cities.get("Salt Lake City"), 5, null, PASSENGER, 14, 13));
        ...
        routes.put(18, new Route(cities.get("Las Vegas"), cities.get("Salt Lake City"), 3, null, FREIGHT, 18, -1));
        ...
        routes.put(24, new Route(cities.get("Phoenix"), cities.get("Denver"), 5, null, PASSENGER, 24, -1));
        ...
        routes.put(32, new Route(cities.get("Denver"), cities.get("Omaha"), 4, null, BOX, 32, -1));
        routes.put(33, new Route(cities.get("Denver"), cities.get("Kansas City"), 4, null, HOPPER, 33, 34));
        routes.put(34, new Route(cities.get("Denver"), cities.get("Kansas City"), 4, null, FREIGHT, 34, 33));
        ...
        routes.put(42, new Route(cities.get("Oklahoma City"), cities.get("Santa Fe"), 3, null, TANKER, 42, -1));
        routes.put(43, new Route(cities.get("Oklahoma City"), cities.get("El Paso"), 5, null, REEFER, 43, -1));
        ...
        routes.put(52, new Route(cities.get("Kansas City"), cities.get("Saint Louis"), 2, null, TANKER, 52, 53));
        routes.put(53, new Route(cities.get("Kansas City"), cities.get("Saint Louis"), 2, null, BOX, 53, 52));
        ...
        routes.put(58, new Route(cities.get("Duluth"), cities.get("Toronto"), 6, null, BOX, 58, -1));
        ...
        routes.put(64, new Route(cities.get("Chicago"), cities.get("Saint Louis"), 2, null, PASSENGER, 64, 63));
        routes.put(65, new Route(cities.get("Chicago"), cities.get("Omaha"), 4, null, TANKER, 65, -1));
        routes.put(66, new Route(cities.get("Chicago"), cities.get("Pittsburgh"), 3, null, HOPPER, 66, 67));
        routes.put(67, new Route(cities.get("Chicago"), cities.get("Pittsburgh"), 3, null, FREIGHT, 67, 66));
        routes.put(68, new Route(cities.get("Chicago"), cities.get("Toronto"), 4, null, PASSENGER, 68, -1));
        ...
        routes.put(71, new Route(cities.get("Pittsburgh"), cities.get("Nashville"), 4, null, REEFER, 71, -1));
        ...
        routes.put(74, new Route(cities.get("Pittsburgh"), cities.get("New York"), 2, null, PASSENGER, 74, 75));
        ...
        routes.put(77, new Route(cities.get("Montreal"), cities.get("New York"), 3, null, TANKER, 77, -1));
        ...
        routes.put(80, new Route(cities.get("Boston"), cities.get("New York"), 2, null, REEFER, 80, 81));
        routes.put(81, new Route(cities.get("Boston"), cities.get("New York"), 2, null, COAL, 81, 80));
        routes.put(82, new Route(cities.get("New York"), cities.get("Washington"), 2, null, FREIGHT, 82, 83));
        ...
        routes.put(92, new Route(cities.get("Nashville"), cities.get("Little Rock"), 3, null, PASSENGER, 92, -1));
        ...
        routes.put(96, new Route(cities.get("New Orleans"), cities.get("Atlanta"), 4, null, REEFER, 96, 97));
        routes.put(97, new Route(cities.get("New Orleans"), cities.get("Atlanta"), 4, null, FREIGHT, 97, 96));
        routes.put(98, new Route(cities.get("Atlanta"), cities.get("Charleston"), 2, null, ANY, 98, -1));
        routes.put(99, new Route(cities.get("Atlanta"), cities.get("Miami"), 5, null, TANKER, 99, -1));
        routes.put(100, new Route(cities.get("Charleston"), cities.get("Miami"), 4, null, BOX, 100, -1));
        return routes;
    }
}
